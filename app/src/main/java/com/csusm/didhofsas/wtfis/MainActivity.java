...
public class MainActivity extends Activity implements View.OnClickListener, AdapterView.OnItemClickListener, AdapterView.OnItemSelectedListener, TextWatcher, View.OnFocusChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        db.createCountry(1, "Austrailia", true);
        ...
        db.linkCountryUnit(0, "argentina peso");
        ...
        db.linkCountryUnit(1, "austailian dollar");
        ...
        db.linkCountryUnit(4, "brazil real");
        ...
        db.linkCountryUnit(6, "chile peso");
        ...
        db.linkCountryUnit(9, "Danishe Crones");
        ...
        db.linkCountryUnit(18, "norwegian krone");
        ...
        db.linkCountryUnit(21, "russion ruble");
        ...
        db.linkCountryUnit(22, "south africa rand");
        ...
        db.linkCountryUnit(24, "Sweeden Krones");
        ...
        db.linkCountryUnit(25, "Swiss Franc");
