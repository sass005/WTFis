...
public class MainActivity extends Activity implements View.OnClickListener, AdapterView.OnItemClickListener, AdapterView.OnItemSelectedListener, TextWatcher, View.OnFocusChangeListener {
    ...
    TextView homeUnitShow, travelUnitShow, lastUpdateShow;              //TextViews above input fields
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        db = new CountrycodeDataSource(this);
        db.open();

        DatabaseTools dt = new DatabaseTools(this);
        dt.fillDatabaseIfNotExists();
        ...
        homeUnitShow = (TextView) findViewById(R.id.homeunitview);
        travelUnitShow = (TextView)findViewById(R.id.travelunitview);
        lastUpdateShow = (TextView)findViewById(R.id.last_update_show);
        cTable =(Button)findViewById(R.id.cTable_button);
    ...
    public void onClick(View v)
    {
        ...
        switch (v.getId())
        {
            ...
            case R.id.change_country_button:
                ...
                break;
            case R.id.cTable_button:
                Intent intent2 = new Intent (this, ConversionTable.class);
